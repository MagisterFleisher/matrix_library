 ...
 * @brief This function performs scalar matrix subtraction.  It modifies the matrix passed to the function
 * @param m matrix_double_t The matrix
 * @param scalar const double The scalar used for subtraction 
 */
void
...
/**
 * @brief Finds the dot product of two double arrays of equal size
 ...
 */
double
m_determinant_double(matrix_double_t *m);
 ...
 */
bool
m_nilPotentDegree_double(matrix_double_t *m);
 ...
 */
bool
m_isInvertable_double(matrix_double_t *m);
 ...
 */
bool
m_isRightStochastic_double(matrix_double_t *m);
 ...
 */
bool
m_isLeftStochastic_double(matrix_double_t *m);
 ...
 */
bool
m_isDoublyStochastic_double(matrix_double_t *m);
 ...
 */
bool
m_isSubStochastic_double(matrix_double_t *m);
